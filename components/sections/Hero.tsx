        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <motion.h1
              ...
              className="heading-lg mb-6 leading-tight font-bold text-emerald-950 dark:text-emerald-50"
            >
            ...
            <motion.p
              variants={itemVariants}
              className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-xl mx-auto lg:mx-0 font-medium"
            >
              {dict.hero.desc}
            </motion.p>
            ...
            <motion.div
              variants={containerVariants}
              className="grid grid-cols-3 gap-4 sm:gap-6 mt-12 border-t border-gray-200 dark:border-gray-800 pt-8"
            >
              {[
          ...
          >
            <div className="relative h-[350px] sm:h-[450px] lg:h-[600px] w-full rounded-3xl overflow-hidden shadow-2xl shadow-emerald-900/20 dark:shadow-black/50 border border-emerald-100 dark:border-slate-800 bg-gray-100 dark:bg-slate-900">
              <AnimatePresence mode="wait" initial={false}>
                ...
                >
                  <Image
                    ...
                    alt={`GX-GLOBAL logistics and supply chain slide ${
                      currentImage + 1
                    }`}
                    fill
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-emerald-950/60 via-emerald-950/10 to-transparent pointer-events-none" />

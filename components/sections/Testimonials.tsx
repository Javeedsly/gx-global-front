      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {dict.items.map((testimonial: any, index: number) => (
            ...
            >
              <div className="text-5xl text-emerald-800/10 absolute top-4 right-6 font-serif select-none">"</div>
              ...
              <div className="mt-auto">
                ...
                <div className="text-xs md:text-sm font-semibold text-emerald-700">{testimonial.role}</div>

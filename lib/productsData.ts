...
export const products = [
  ...
  // TESS-SAN
  { id: 48, name: 'EUROLUB BR 40', category: 'TESS-SAN', image: '/1-varil.jpg', descKey: 'tessSan' },
  { id: 49, name: 'EUROLUB BR 60', category: 'TESS-SAN', image: '/1-varil.jpg', descKey: 'tessSan' },
  { id: 50, name: 'EUROLUB BR 80', category: 'TESS-SAN', image: '/1-varil.jpg', descKey: 'tessSan' },
  { id: 51, name: 'COLDEX 2002', category: 'TESS-SAN', image: '/1-varil.jpg', descKey: 'tessSan' },
  { id: 52, name: 'COLDEX 2077 AF', category: 'TESS-SAN', image: '/1-varil.jpg', descKey: 'tessSan' },
  { id: 53, name: 'COLDEX 2090', category: 'TESS-SAN', image: '/1-varil.jpg', descKey: 'tessSan' },
  { id: 54, name: 'EUROGRIND A', category: 'TESS-SAN', image: '/1-varil.jpg', descKey: 'tessSan' },
  { id: 55, name: 'EUROGRIND ACo', category: 'TESS-SAN', image: '/1-varil.jpg', descKey: 'tessSan' },
  { id: 56, name: 'EUROGRIND TE 305', category: 'TESS-SAN', image: '/1-varil.jpg', descKey: 'tessSan' },
  { id: 57, name: 'FORCE K 102 B', category: 'TESS-SAN', image: '/1-varil.jpg', descKey: 'tessSan' },
  { id: 58, name: 'FORCE K 102 DK', category: 'TESS-SAN', image: '/1-varil.jpg', descKey: 'tessSan' },

  // SPEEDOL
  { id: 59, name: 'PETROL OIL SAE-40', category: 'SPEEDOL', image: '/PETROL-OIL-SAE-40.webp', descKey: 'speedol' },
  { id: 60, name: 'DIESEL OIL SAE-50', category: 'SPEEDOL', image: '/DIESEL-OIL-SAE-50.webp', descKey: 'speedol' },
  { id: 61, name: 'DIESEL ENGINE OIL SAE 15W40', category: 'SPEEDOL', image: '/SAE-15W40-DIESEL-ENGINE-OIL.png', descKey: 'speedol' },
  { id: 62, name: 'MULTIGRADE-20W50', category: 'SPEEDOL', image: '/multigrade-20l.webp', descKey: 'speedol' },
  { id: 63, name: 'TWO STROKE OIL', category: 'SPEEDOL', image: '/TWO-STROKE-OIL.webp', descKey: 'speedol' },
  { id: 64, name: 'COMPRESSOR OIL R68', category: 'SPEEDOL', image: '/COMPRESSOR-OIL--R68-.webp', descKey: 'speedol' },
  { id: 65, name: 'CHAINLUBE', category: 'SPEEDOL', image: '/CHAINLUBE.webp', descKey: 'speedol' },
